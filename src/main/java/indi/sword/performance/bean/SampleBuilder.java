...
public class SampleBuilder {
    ...
    public static void buildJsonSamplesByType(List<SampleEntity> list , int typeCode, int sampleSize ,
        ...
        buildJsonSamples(list, path, typeCode);
    }
    ...
    public static void buildJsonSamples(List<SampleEntity> list,String filePath,int typeCode) throws Exception {

        StringBuilder sb = new StringBuilder();
        for (SampleEntity item : list) {
            sb.append(JsonUtil.javaBeanToJson(item, typeCode));
            sb.append("\n");
        }
        FileUtil.writeFile(sb.toString(),filePath,false);
    }

    public static List<String> buildJsonSamples(List<SampleEntity> list,int typeCode) throws Exception {

        List<String> jsonList = new LinkedList<>();
        for (SampleEntity item : list) {
            jsonList.add(JsonUtil.javaBeanToJson(item, typeCode));
        }
        return jsonList;
    }
